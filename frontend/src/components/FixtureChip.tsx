...
export function FixtureChip({ fixture }: { fixture: FixtureDifficulty }) {
  return (
    <span
      ...
      className={`inline-block w-14 shrink-0 rounded-md px-1.5 py-0.5 text-center text-xs font-medium ${DIFFICULTY_COLORS[fixture.difficulty] ?? "bg-slate-300"}`}
    >
